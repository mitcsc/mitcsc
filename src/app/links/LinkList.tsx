      ...
      {links.map((link) => {
        ...
        return (
          <a
            ...
            className="group relative w-full py-4 px-6 border border-white/20 rounded-lg text-center font-secondary font-normal text-lg md:text-xl hover:bg-primary hover:border-primary transition-all duration-300 ease-out overflow-hidden text-balance"
